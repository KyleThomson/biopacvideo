...
namespace ProjectManager
{
    ...
    public class Project
    {
        ...
        private void TrackAnimal(AnimalType animal)
        {
            ...
            {
                if (file.AnimalIDs.Contains(animal.ID) && !_appeared && _firstAppearance)
                // Track earliest time that animal ID appears 
                { earliest = file.Start.Date; _appeared = true; _firstAppearance = false; }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
                ...
                {
                    latest = file.Start.Date; _appeared = false;
                }
            }
